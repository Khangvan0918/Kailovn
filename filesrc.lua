...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>modbykailo chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "modbykailo", HidePremium = false, IntroText = "modbykailo⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("modbykailo SCRIPT")
W:AddLabel("Discordmodbykailo")
local Section = W:AddSection({
    Name = "Status"
})
